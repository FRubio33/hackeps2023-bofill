...
while True:
    ...
    for group in groups:
        x_min = min([face[0] for face in group])
        y_min = min([face[1] for face in group])
        x_max = max([face[0]+face[2] for face in group])
        y_max = max([face[1]+face[3] for face in group])
